...
<x-slot name="head">
    ...
    <div class=" gap-2 mb-6 relative z-30">
        ...
        <div class="flex flex-wrap justify-end">
            ...
            <a href="{{ route('classmodule.create') }}"
                                ...
                                <div class="relative">
                                    ...
                                    <div
                                        ...
                                        <div class="py-2" role="menu">
                                            ...
                                            <a href="{{ route('classmodule.edit',$row->id) }}"
                                          ...
                                          <form action="{{ route('classmodule.destroy', $row->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
