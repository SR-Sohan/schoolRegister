...
<x-slot name="head">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Groups</h1>
    </x-slot>
    <div class=" gap-2 mb-6 relative z-30">
        ...
        <div class="flex flex-wrap justify-end">
            ...
            <a href="{{ route('groupmodule.create') }}"
                                ...
                                <div class="relative">
                                    ...
                                    <div
                                        ...
                                        <div class="py-2" role="menu">
                                          ...
                                          <form action="{{ route('groupmodule.destroy', $row->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
