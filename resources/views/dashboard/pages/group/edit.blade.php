<x-app-layout>
    <x-slot name="head">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Group Edit</h1>
    </x-slot>
    ...
    <div class="glass-effect rounded-2xl p-8 shadow-2xl bg-white dark:bg-gray-900">
        ...
        <form action="{{ route('groupmodule.update', $classModule->id) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
             @csrf
            @method('PUT')
