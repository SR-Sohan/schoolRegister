<x-app-layout>
    <div class="min-h-screen bg-[#f9fafb] dark:bg-gray-900 py-10 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-8">➕ Create New Role</h1>
            ...
            <form action="{{ route('roles.store') }}" method="POST" class="space-y-8">
                ...
                <div class="pt-4 text-right">
                    <button type="submit"
                        class="bg-blue-600 hover:bg-bluw-700 text-white dark:text-white font-semibold py-2 px-6 rounded-lg shadow transition duration-300">
                        ✅ Create Role
                    </button>
                </div>
            </form>
